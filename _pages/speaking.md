...
<style>
  ...
  .speech-item a {
    ...
    color: #333; /* 深灰色 */
    border-bottom: 1px dashed #ccc; /* 虚线下划线，由点变虚线更精致 */
    transition: all 0.2s;
    display: block; /* 让整行都能被点到 */
    padding: 8px 5px; /* 稍微增加内边距，点击区域更大 */
    border-radius: 4px; /* 轻微圆角 */
  }

  .speech-item a:hover {
    color: #d9534f; /* 悬停变成中欧红 */
    border-bottom: 1px solid #d9534f; /* 边框变实线 */
...
<div class="speech-list">
  ...
  <div class="speech-item">
    <a href="https://cn.ceibs.edu/new-papers-columns/29496" target="_blank"
      ...
      “投资A股时，怎么看硬科技公司？” 中欧国际工商学院. 谭寅亮. 2026年7月.
    </a>
  </div>
...
<div class="speech-list">
  ...
  <div class="speech-item">
    <a href="https://cn.ceibs.edu/media/press-clippings/faculty/28384" target="_blank"
       title="企业真正的战略优势在于将AI协作智商转化为可持续的共创能力，使AI成为认知伙伴而非单纯工具。">
...
<div class="speech-list">
  ...
  <div class="speech-item">
    <a href="https://cn.ceibs.edu/media/press-clippings/faculty/28383" target="_blank"
       title="电力已成为继数据、算法、算力之后的第四个关键要素，决定了AI产业扩张的物理上限。">
...
<div class="speech-list">
  ...
  <div class="speech-item">
    <a href="https://cn.ceibs.edu/media/press-clippings/faculty/28324" target="_blank"
       title="通过检测与赔付保障机制结合AI技术，中国二手车行业正从柠檬市场转型为风险可控的服务型产业。">
...
<div class="speech-list">
  ...
  <div class="speech-item">
    <a href="https://cn.ceibs.edu/media/press-clippings/faculty/26222" target="_blank"
       title="生成式AI是强大的决策辅助工具，但短期内无法替代CEO的战略决策，应采取人机协作模式。">
